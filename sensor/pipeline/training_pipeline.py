...
import sys
from sensor.component.A_data_ingestion_component import DataIngestioncomponet
...
class TrainPipeline:
    ...
    def start_data_ingestion(self)->DataIngestionArtifact:
        try:
            ...
            data_ingestion=DataIngestioncomponet(data_ingestion_config=self.data_ingestion_config)
